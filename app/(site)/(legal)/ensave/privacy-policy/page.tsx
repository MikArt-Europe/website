    ...
    return (
        <div className="container mx-auto p-8 my-4">
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>
                    <strong>Application</strong> refers to EnSave, the software program provided by the Company.
                </li>
                <li>
                    <strong>Company</strong> (referred to as either &#34;the Company&#34;, &#34;We&#34;, &#34;Us&#34; or
                    &#34;Our&#34; in this Agreement) refers to EnSave.
                </li>
                <li>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>
                    <strong>For the features we provide</strong>, it&#39;s essential for more than half of the features
                    we provide.
                </li>
            </ul>
            <p className="text-lg leading-relaxed mb-4">

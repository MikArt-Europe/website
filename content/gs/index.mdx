...
We have developed a new groundbreaking way to use a fabric mod to authenticate automatically using cryptographically signed keys. This is far more secure, and it cannot be stolen unless your machine is compromised by malware.
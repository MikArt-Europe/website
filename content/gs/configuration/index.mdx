import { FileTree, Table } from 'nextra/components'
...
<FileTree>
    <FileTree.Folder name="GroupSecurity" defaultOpen>
        <FileTree.File name="config.yml" />
        <FileTree.File name="messages-xx-xx.yml" />
    </FileTree.Folder>
</FileTree>
...
<Table>
    ...
    <Table.Tr>
        ...
        <Table.Th>BCRYPT</Table.Th>
        <Table.Th>Argon2</Table.Th>
        <Table.Th>Scrypt</Table.Th>
    </Table.Tr>
    </thead>
    <tbody>
    <Table.Tr>
        ...
        <Table.Td>🔵 Very Strong</Table.Td>
        <Table.Td>🟢 Strong</Table.Td>
    </Table.Tr>
    <Table.Tr>
        <Table.Td>Speed</Table.Td>
        <Table.Td>🟠 Slow</Table.Td>
        <Table.Td>🟠 Slow</Table.Td>
        <Table.Td>🟠 Slow</Table.Td>
    </Table.Tr>
    <Table.Tr>
    ...
    <Table.Tr>
        <Table.Td>CPU Usage</Table.Td>
        <Table.Td>🟢 Low</Table.Td>
        <Table.Td>🔴 High</Table.Td>
        <Table.Td>🔴 High</Table.Td>
    </Table.Tr>
    <Table.Tr>
        <Table.Td>GPU Resistant</Table.Td>
        <Table.Td>✅ Yes</Table.Td>
        <Table.Td>✅ Yes</Table.Td>
        <Table.Td>✅ Yes</Table.Td>
    </Table.Tr>
    <Table.Tr>
        <Table.Td>Hashing Type</Table.Td>
        <Table.Td>🔄 Adaptive</Table.Td>
        <Table.Td>🔄 Adaptive</Table.Td>
        <Table.Td>🔄 Adaptive</Table.Td>
    </Table.Tr>
    <Table.Tr>
...
##### argon2
* `memory`: The amount of memory to use in KB. Default is 65536 (64MB).
* `iterations`: The number of iterations to use. Default is 3.
* `parallelism`: The parallelism to use. Default is 1.
##### scrypt
* `memory`: The amount of memory to use in KB. Default is 65536 (64MB).
* `iterations`: The number of iterations to use. Default is 16384.
* `parallelism`: The parallelism to use. Default is 1.
#### pin

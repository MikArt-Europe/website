...
title: Allowed Mods
full: true
description: Describes the allowed modifications on the MikArt Europe Network.
---

# Allowed Modifications

Parts of the allowed modification guide are done with inspiration from [Hypixel's allowed modifications](https://support.hypixel.net/hc/en-us/articles/6472550754962-Hypixel-Allowed-Modifications).

<Callout type="warning">
    **Warning**: Before using any modifications please be aware that all use of modifications on our server is at your
    own risk, including the ones we list as examples in this guide. We cannot review every version of every
    modification, and as such we cannot provide any guarantees of modifications being within our server rules.
</Callout>

Generally speaking, you should be fine if your modification is purely cosmetic and doesn't give you an advantage over other players.
The modification shouldn't give you information that you would not normally have access to, or automate gameplay in any way.
I still suggest you reading the whole page if you're unsure about your mod. The staff team happily helps you with any questions you
may have about the modifications you're using.

...
export default function Page() {
    return (
        <BackgroundGradientAnimation>
            <div
                className="absolute z-50 inset-0 flex items-center justify-center text-white font-bold px-4 pointer-events-none text-3xl text-center md:text-4xl lg:text-7xl flex-col">
                    ...
                    <main className="container mx-auto px-4 py-10 md:py-20">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-lg p-6">
                                        <p className="text-gray-300 leading-relaxed">
                                            I specialize in creating modern web applications with modern tech stack.
                                            I have experience in building web applications with React, Next.js, Node.js,
                                            and
                                            more.
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        >
                                            <SiGithub size={20}/>
                                            <span
                                                className="border-b border-dotted border-transparent group-hover:border-white/50">GitHub</span>
                                        </Link>
                                        ...
                                        >
                                            <Mail size={20}/>
                                            <span
                                                className="border-b border-dotted border-transparent group-hover:border-white/50">Contact</span>
                                        </Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="lg:col-span-7">
                                <h2 className="text-2xl font-medium text-white mb-6 pb-2 border-b border-white/10">Selected
                                    Work</h2>
                                    ...
                                    {projects.map((project) => (
                                        <Card key={project.title}
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                                                <div className="md:col-span-2 h-36 md:h-full relative">
                                                    <div className="w-full h-full overflow-hidden">
                                                        {project.comingSoon ? (
                                                            <div
                                                                className="w-full h-full flex items-center justify-center bg-black/30 backdrop-blur-sm">
                                                                <p className="text-lg font-medium text-white/70 rotate-[-5deg] border border-white/20 px-4 py-2 rounded">
                                                                    Coming Soon
                                                                </p>
                                                            </div>
                                                        ) : (
                                                ...
                                                <CardContent
                                                    className="md:col-span-3 p-4 flex flex-col justify-between">
                                                    <div>

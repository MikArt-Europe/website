                            ...
                            <div className="flex flex-col justify-center items-center w-full">
                                <div
                                    ...
                                    <p className={`${styles.paragraph} ml-2`}>
                                        ...
                                        className='text-white'>{currentMessage}</span> by <span
                                ...
                                <h1 className='font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px] text-center'>
                                    <p className='ss:text-[62px] text-[42px]'>Modern projects designed <br
                                        className="sm:block hidden"/>with <span className="text-gradient">care</span>
                ...
                <div className={`${styles.boxWidth}`}>
                    <section id='' className={layout.section}>
                        <div className={layout.sectionInfo}>
                            ...
                            <p className={`${styles.paragraph} max-w-[470px]`}>These blogs are written by someone in our
                                project.</p>
                    ...
                    <section className={layout.sectionReverse}>
                        <div className={layout.sectionImgReverse}>
                            <div style={{width: '100%', height: '100%', position: 'relative'}}>
                                <Image src={"/assets/animvanish.png"} alt='card'

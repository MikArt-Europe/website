                        ...
                        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                            <div className="flex flex-col justify-center items-center w-full">
                                ...
                                <h1 className='font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px] text-center'>
                                    <p className='ss:text-[62px] text-[42px]'>Modern projects designed <br className="sm:block hidden"/>with <span className="text-gradient">care</span> <br className="sm:block hidden"/></p>
                                </h1>
                ...
                <div className={`${styles.boxWidth}`}>
                    <section id='' className={layout.section}>
                        <div className={layout.sectionInfo}>
                            ...
                            <p className={`${styles.paragraph} max-w-[470px]`}>These blogs are written by someone in our project.</p>
                    ...
                    <section className={layout.sectionReverse}>
                        <div className={layout.sectionImgReverse}>
                            <div style={{width: '100%', height: '100%', position: 'relative'}}>
                                <Image src={"/assets/animvanish.png"} alt='card' className='w-[500px] h-[500px] rounded-3xl'

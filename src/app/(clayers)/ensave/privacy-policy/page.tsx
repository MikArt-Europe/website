...
export default function PrivacyPage() {
    return (
        <div className="container mx-auto p-8 my-4">
            ...
            <p className="text-lg leading-relaxed mb-4">
                We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/">Privacy Policy Generator</a>.
            </p>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li><strong>Application</strong> refers to EnSave, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either &#34;the Company&#34;, &#34;We&#34;, &#34;Us&#34; or &#34;Our&#34; in this Agreement) refers to EnSave.</li>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li><strong>For the features we provide</strong>, it&#39;s essential for more than half of the features we provide.</li>
            </ul>
            <p className="text-lg leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-semibold mb-4 mt-8">Links to Other Websites</h2>
            <Separator className="mb-6" />
            <p className="text-lg leading-relaxed mb-4">
